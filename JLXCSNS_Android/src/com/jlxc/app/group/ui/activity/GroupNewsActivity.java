...
public class GroupNewsActivity extends BaseActivityWithTopBar {
	...
	private void init() {
		...
		newsOPerate = new NewsOperate(GroupNewsActivity.this);
		// 获取显示图片的实例
	...
	private void newsListViewSet() {
		...
		// 添加顶部布局
		View header = View.inflate(GroupNewsActivity.this,
				R.layout.group_news_item_head_layout, null);// 头部内容
		newsListView.getRefreshableView().addHeaderView(header);

		/**
		 * adapter的设置
		 * */
		newsAdapter = new HelloHaAdapter<GroupItemModel>(
